		...
		<nav class="text-center">
			<ul class="pagination">
				<% if (pi.getCurrent_page() != 1) { %>
					<li><a href="/lar/admin/commu/notice/list/1">&lt;&lt;</a></li>
					<li><a href="/lar/admin/commu/notice/list/${pi.current_page -1}">&lt;</a></li>				
				<% } %>
				...
				<% if (pi.getMax_page_count() > pi.getCurrent_page()) { %>
					<li><a href="/lar/admin/commu/notice/list/${pi.current_page + 1}">&gt;</a></li>
					<li><a href="/lar/admin/commu/notice/list/${pi.max_page_count}">&gt;&gt;</a></li>
				<% } %>
			</ul>
		</nav>
	</div>
